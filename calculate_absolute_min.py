...
data = pd.read_csv('daily_forecasts_with_category.csv')
data_monthly = pd.read_csv('monthly_forecasts_with_category.csv')
...
data.to_csv('daily_forecasts_with_category_with_min_diff.csv', index=False)
data_monthly.to_csv('monthly_forecasts_with_category_with_min_diff.csv', index=False)
